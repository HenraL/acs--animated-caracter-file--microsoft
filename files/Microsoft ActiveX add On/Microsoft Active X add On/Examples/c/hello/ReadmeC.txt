...
2. Copy the character animation files for the three standard characters 
to your hard disk: Genie.acs, Merlin.acs and Robby.acs.  Create a directory
...
1. Copy the required include files from the CD to your hard disk.  Create a local 
directory for these files.  (For instance, /Program Files/Micrsoft Agent/Include/)
...
1. Create a local directory for the sample.  (For instance, 
/Program Files/DevStudio/MyProjects/AgentSample/)  Copy the samples files
from the CD into the directory you created.
