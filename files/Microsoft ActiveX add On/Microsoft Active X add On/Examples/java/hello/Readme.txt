Hello World (Java) Sample for Microsoft Agent
---------------------------------------------
...
The character animation file Merlin.acs should be copied to that
...
(HelloJ.dsw) for this sample.  Click Open.
...
the sample: "HelloJ", then click OK.  Note that the name is case sensitive.